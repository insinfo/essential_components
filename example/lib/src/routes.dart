...
import 'pages/accordeon_example/accordeon_example.template.dart' as accordeon_template;
import 'pages/content_page/content_component.template.dart' as home_template;
import 'pages/datapicker_component/datapicker_component.template.dart' as datapicker_template;
import 'pages/datatable_component/datatable_component.template.dart' as datatable_template;
import 'pages/dropdown_dialog_component/dropdown_dialog_component.template.dart' as dropdown_template;
import 'pages/dynamic_tabs_component/dynamic_tabs_component.template.dart' as dynamic_tabs_template;
import 'pages/modal_component/modal_component.template.dart' as modal_template;
import 'pages/notification_component/notification_component.template.dart' as notification_template;
import 'pages/recaptcha_example/recaptcha_example.template.dart' as recaptcha_template;
import 'pages/select_dialog_component/select_dialog_component.template.dart' as select_dialog_template;
import 'pages/simple_card_example/simple_card_example.template.dart' as simple_card_template;
import 'pages/simple_dialog_component/simple_dialog_component.template.dart' as simple_dialog_template;
import 'pages/simple_loading_component/simple_loading_component.template.dart' as simple_loading_template;
import 'pages/simple_select_component/simple_select_component.template.dart' as simple_select_template;
import 'pages/timeline_component/timeline_component.template.dart' as timeline_component_template;
import 'pages/toast_component/toast_component.template.dart' as toast_template;
import 'pages/rest_api_example/rest_api_example.template.dart' as rest_api_template;
